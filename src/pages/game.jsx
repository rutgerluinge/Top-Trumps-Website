      ...
      <div className="div_span">
        <div className="paragraph">
          ...
          <div className="paragraph vw_80">
            ...
            the highest value wins the round, and receivs all other players
            cards and puts them at the bottom of the deck.
          </div>
          ...
          <div className="paragraph">
            ...
            <ol>
              ...
              <li>Decide the round start player (last round winner)</li>
              <li>Round start player picks category</li>
              <li>All players name the value of the picked category</li>
              <li>The player with the highest value wins all cards</li>
              <li>
        ...
        <div className="paragraph">
          <div className="div_span">
            <img src={card_image} alt="card example" />
            <img src={card_2_image} alt="card example" />
          </div>
          <div>
